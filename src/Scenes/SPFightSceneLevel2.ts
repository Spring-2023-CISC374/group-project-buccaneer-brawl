...
export default class SPFightSceneLevel2 extends Phaser.Scene {
  constructor() {
    super({ key: 'SPFightSceneLevel2' });
  }
  private aiMoves = ['kick', 'punch', 'move_forward', 'jump'];
